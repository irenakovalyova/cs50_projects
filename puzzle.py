...
knowledge1 = And(
    ...
    Implication(Not(And(BKnave, AKnave)), And(AKnave, BKnight))
)
...
knowledge2 = And(
    ...
    Implication(Or(And(AKnight, Not(BKnight)), And(AKnave, Not(BKnave)), And(BKnave, Not(AKnave)), And(BKnight, Not(AKnight))), And(BKnight, AKnave)),
    Implication(Not(Or(And(AKnight, Not(BKnight)), And(AKnave, Not(BKnave)), And(BKnave, Not(AKnave)), And(BKnight, Not(AKnight)))), BKnave)
)
